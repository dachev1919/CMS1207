...
<!--product-starts-->
<?php if($hits): ?>
<?php $curr = \cms1207\App::$app->getProperty('currency'); ?>
<div class="product">
    <div class="container">
                ...
                <div class="col-md-3 product-left">
                    <div class="product-main simpleCart_shelfItem">
                        ...
                        <div class="product-bottom">
                            <h3>
                                <a href="product/<?= $hit->alias; ?>"><?= $hit->title; ?></a></h3>
                            <p>Explore Now</p>
                            <h4>
                                <a data-id="<?= $hit->id ?>" class="add-to-card-link" href="card/add?id=<?= $hit->id;?>"><i></i></a>
                            ...
                            <?php if ($hit->old_price):?>
                                <div class="srch">
                                    <span><?= $hit->price - $hit->old_price; ?></span>
                                </div>
                            <?php endif; ?>
                    </div>
                </div>
